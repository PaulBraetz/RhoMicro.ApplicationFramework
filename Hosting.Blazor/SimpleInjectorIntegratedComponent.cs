...
using global::RhoMicro.ApplicationFramework.Common.Abstractions;
...
public abstract class SimpleInjectorIntegratedComponent : ComponentBase, IHandleEvent
{
    ...
    /// </summary>
    [Injected]
    public required ServiceScopeApplier ServiceScopeApplier { get; set; }
    ...
    {
        ServiceScopeApplier.ApplyServiceScope();
