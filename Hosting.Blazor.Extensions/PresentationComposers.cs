...
internal static class PresentationComposers
{
    ...
    private static IComposer WithModels(this IComposer composer) => Composer.Create(composer, Models);
    /// <summary>
    ...
    public static IComposer Models { get; } = Composer.Create(c =>
    {
        ...
        c.Register<IAuthenticationConsumerModel, AuthenticationModel>(Lifestyle.Scoped);
        c.Register<IAuthenticationProviderModel, AuthenticationModel>(Lifestyle.Scoped);
