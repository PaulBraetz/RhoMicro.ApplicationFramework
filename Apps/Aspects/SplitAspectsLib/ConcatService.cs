...
partial class ConcatService
{
    ...
    static String Concat([Intercept]String a, String b) => throw new NotSupportedException("The service is not supported client-side. Make sure to register an api client implementation instead.");
